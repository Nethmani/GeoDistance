(() => {
  ...
  const resetMap = () => { mapContent.innerHTML = '<text x="320" y="154" text-anchor="middle">Enter coordinates to visualise them</text>'; mapSummary.hidden = true; mapSummary.innerHTML = ''; };
  ...
  form.addEventListener('submit', async event => {
    ...
    try {
      ...
      result.hidden = false; renderMap(c); showMessage('Distance calculated successfully.', 'success'); loadHistory();
